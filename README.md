...
**VETCLINIC** is a database that includes information of the clinical animals and the medical records associated with.
...
In order to run this project you need:
 ...
 - then Create a Database and run the commands in my github repository.
  
    1.commands in my schema.sql file

    2.commants in my data.sql file to insert data into tables

    3.commands in my queries.sql file to search the data in tables.
...
```sh
git clone https://github.com/yashodhicy/VetClinic.git
```
...
Feel free to check the [issues page](https://github.com/yashodhicy/VetClinic/issues).
